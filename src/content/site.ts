  ...
  about: {
    ...
    bios: [
      ...
      },
      {
        ...
        image: "/images/katerina_profile.jpg",
        paragraphs: [
          "Katerina Minevich, CFP®, CDFA®, is a wealth manager and financial planning strategist specializing in financial decision-making during complex life transitions. She partners with individuals, families and business owners seeking clarity and structure as they evaluate major financial choices involving family dynamics, tax exposure, and long-term financial independence. Katerina co-founded Forward Wealth Management with Hilal Yilmaz and leads the firm’s client financial planning strategy.",
          "Katerina approaches wealth management through the lens of financial strategy and decision analysis. Her work focuses on helping clients evaluate how significant financial decisions—from divorce settlements and changes in family structure to education funding and liquidity events—may influence long-term financial sustainability. By translating complex financial scenarios into clear decision frameworks, she helps clients understand trade-offs, compare potential outcomes, and move forward with clarity and confidence.",
          ...
          "Before co-founding Forward Wealth Management, Katerina held senior financial leadership roles at a high-growth technology company through multiple funding rounds and a $425 million acquisition. She led financial planning, forecasting, and capital strategy initiatives and advised executives and employees navigating equity compensation and liquidity events. Earlier in her career, she worked at the U.S. Securities and Exchange Commission examining registered investment advisers, hedge funds, and mutual funds — experience that continues to inform her perspective on fiduciary oversight and investment governance.",
          "Katerina earned her Bachelor’s degree in Economics from New York University and maintains the CERTIFIED FINANCIAL PLANNER™ (CFP®) and Certified Divorce Financial Analyst® (CDFA®) designations. She serves on the Board of Directors of the Financial Planning Association of Los Angeles as Director of Corporate Sponsorships.",
        ],
      },
    ],
  },
