    ...
    members: [
      {
        ...
        linkedin: "https://www.linkedin.com/in/katerina-minevich/",
      ...
      },
      {
        ...
        linkedin: "https://www.linkedin.com/in/hilal-yilmaz-phd-cfa-a875b05/",
    ...
    bios: [
      {
        ...
        image: "/images/hilal_profile.jpg",
        paragraphs: [
          "Hilal Yilmaz, PhD, CFA, is a wealth manager and quantitative investment strategist specializing in tax-efficient, life-span portfolio architecture. She partners with clients seeking clarity, coordination, and long-term structure in their financial lives. Hilal co-founded Forward Wealth Management with Katerina Minevich and leads investment strategy for the firm, designing portfolios that evolve alongside each client's goals.",
          "Hilal approaches wealth management as an integrated system. She designs portfolios that account not only for stocks and bonds, but also for real estate decisions, career trajectories, tax exposure, and the evolving financial roles of the next generation. She works closely with clients' CPAs and estate attorneys to ensure that investment decisions align with broader tax and estate strategies, reducing fragmentation and improving long-term outcomes.",
          "Previously, Hilal served as a Portfolio Manager at Insight Investment Counsel, where she managed approximately $100 million in assets. Following a firm acquisition, she successfully onboarded 50 client households and restructured portfolios to align with firm strategy. She led asset allocation design and tax-loss harvesting strategies while contributing to firmwide research and analytics initiatives.",
      ...
      },
      {
        ...
        image: "/images/katerina_profile.jpg",
        paragraphs: [
          "Katerina Minevich, CFP®, CDFA®, is a wealth manager and financial planning strategist specializing in financial decision-making during complex life transitions. She partners with individuals and families seeking clarity and structure as they evaluate major financial choices involving family dynamics, tax exposure, and long-term financial independence. Katerina co-founded Forward Wealth Management with Hilal Yilmaz and leads the firm’s client financial planning strategy.",
          "Katerina approaches wealth management through the lens of financial strategy and decision analysis. She helps clients evaluate how significant financial decisions—ranging from changes in family structure to liquidity events and long-term planning priorities—affect financial sustainability over time. Her work focuses on translating complex financial scenarios into clear decision frameworks so clients can understand trade-offs and move forward with confidence.",
          "She brings particular expertise to major life transitions, including divorce, the loss of a spouse, and significant changes in family structure. As a Certified Divorce Financial Analyst® (CDFA®), Katerina works with family law attorneys, mediators, and collaborative divorce professionals, providing financial modeling and settlement analysis that help attorneys and clients evaluate the long-term financial consequences of settlement decisions. She also advises individuals and couples on prenuptial and postnuptial financial planning, helping structure agreements that clarify financial expectations and protect long-term family stability.",
          "Katerina helps clients evaluate multiple financial scenarios before making major decisions that shape their financial lives years into the future. Whether considering divorce settlement options, education funding strategies, or liquidity decisions during periods of transition, she helps clients understand how different choices today may shape their financial lives in the years ahead.",
          "Before co-founding Forward Wealth Management, Katerina held senior financial leadership roles at a high-growth technology company through multiple funding rounds and a $425 million acquisition. She led financial planning, forecasting, and capital strategy initiatives and advised executives and employees navigating equity compensation and liquidity events. Earlier in her career, she worked at the U.S. Securities and Exchange Commission examining registered investment advisers, hedge funds, and mutual funds. These experiences continue to inform her advisory work with clients navigating complex financial decisions.",
          "Katerina earned her Bachelor’s degree from New York University and maintains the CERTIFIED FINANCIAL PLANNER™ (CFP®) and Certified Divorce Financial Analyst® (CDFA®) designations. She serves on the Board of Directors of the Financial Planning Association of Los Angeles as Director of Corporate Sponsorships."
        ],
      },
    ],
  },
